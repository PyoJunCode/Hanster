              ...
              Flexible(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(selected ?  selectedClass  : '과목을 선택해 주세요.'  , overflow: TextOverflow.ellipsis ,style:TextStyle(fontFamily: 'Nanumsquare',color: selected? Color(0xFF86a2ea) :Color(0xFFa7a9ac),
                        fontSize: 23.0,
                        fontWeight: FontWeight.w600,),
                      ),
                      Text(selected ?  selectedClassNum  : ' '  , overflow: TextOverflow.ellipsis ,style:
                      TextStyle(fontFamily: 'Nanumsquare',color: Color(0xFFa7a9ac),
                          fontSize: 15.0,
                          fontWeight: FontWeight.w600),
                      )
                    ],
              ...
              GestureDetector(
                onTap: (){
                  ...
                  Navigator.push(context, MaterialPageRoute(
                      builder: (context) => StudyGroup(widget.user, selectedClassNum+". "+selectedClass)));
                },
                child: Container(
                    child: Row(
                      children: <Widget>[
